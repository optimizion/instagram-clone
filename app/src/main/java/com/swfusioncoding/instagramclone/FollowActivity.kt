...
//들어갈 데이터를 만드는 코드
        ...
        bean1.userID = "hello"
        bean1.userName = "hi"
        bean1.userImg = R.drawable.profileimage_sample_1
        var bean2 = FollowBean()
        bean2.userID = "han_ye_seul"
        bean2.userName = "한예슬"
        bean2.userImg = R.drawable.profileimage_sample_16
        var bean3 = FollowBean()
        bean3.userID = "honey_lee32"
        bean3.userName = "이하의 hanee Lee"
        bean3.userImg = R.drawable.profileimage_sample_11
        var bean4 = FollowBean()
        bean4.userID = "madongseok_"
        bean4.userName = "Don Lee 마동석"
        bean4.userImg = R.drawable.profileimage_sample_2
        ...
        bean6.userImg = R.drawable.profileimage_sample_4
        var bean7 = FollowBean()
        bean7.userID = "cifndisle20"
        bean7.userName = "코로나 때문에 화가난다. 이 기분을 알어?"
        bean7.userImg = R.drawable.profileimage_sample_5
        ...
        bean12.userImg = R.drawable.profileimage_sample_9
        ...
        bean14.userName = "지금은 12시 51분.. 언제 자냐?"
